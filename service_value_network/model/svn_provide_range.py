...
from service_value_network.model.model_svn_score import extract_features, create_graph
...
def predict_esg_with_confidence(G, company_name, model, feature_names, n_bootstrap=1000, alpha=0.05):
    ...
    # return information.predict(feature_values)[0], lower_bound, upper_bound
...
'''    company_name = 'IBM'
    # predicted_esg, lower_bound, upper_bound = predict_esg_with_confidence(G, company_name, information, feature_names)
